...
class MelodyStack:
    ...
    def addMelody(self, trackNbr: int, newMelody: Melody):
        ...
        if len(self.file.tracks[trackNbr]) == 0:
            ...
            # melody's notes
            self.file.tracks[trackNbr] = self.file.tracks[trackNbr][1:FIRST_NOTE_MSG_IDX]
            self.file.tracks[trackNbr].insert(0, Message('program_change',
                            program=newMelody.getInstrument(),
                            time=0))
        ...
        for i in range(newMelody.getNumNotes()):
            ...
            self.file.tracks[trackNbr].append(Message('note_off',
                            ...
                            velocity=64,
                            time=noteLen))
        print(self.file.tracks[trackNbr])
